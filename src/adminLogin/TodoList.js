...
//                         <input className='input-todo' type="text" placeholder="✍ Add Items..."
//                            value={inputData} 
...
//                     {/* clear all button  */}
//                     <div className="showItems">
//                         <button className="btn-todo effect04" data-sm-link-text="Remove All" onClick={removeAll}><span> CHECK LIST </span> </button>
//                     </div>
//                 </div>
//           </div>  
//         </>
