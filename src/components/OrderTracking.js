...
const handleRatingChange = (e) => {
  ...
  setRatingStar({ ...ratingStar, [name]: value });
  console.log(ratingStar);
};

const saveRatingInfo=async(e)=>{
  e.preventDefault();
  const {rating}=ratingStar;
  const response=await fetch('rating/saveCustomerRating',{
    method:'POST',
    headers:{
   ...
   */}
      ...
      <div class="container mt-4 mb-4">
        <div class="row d-flex cart align-items-center justify-content-center" style={{height:"100vh"}}>
          <div class="col-md-10">
            <div class="card">
                  ...
                  <div class="progresses">
                    <div class="wrapper">
                      <div class="margin-area">
                        ...
                        {info.beingBaked === "true" ? (
                          <div class="progress-bar first"></div>
                        ) : null}
                        {info.outForDelivery === "true" ? (
        ...
        <h4>Please Rate Our Service!</h4>
          <div class="rating">
            <input type="radio" name="rating" value="5" onChange={handleRatingChange} id="rating-5" />
            <label for="rating-5"></label>
            <input type="radio" name="rating" value="4" onChange={handleRatingChange} id="rating-4" />
            <label for="rating-4"></label>
            <input type="radio" name="rating" value="3"  onChange={handleRatingChange} id="rating-3" />
            <label for="rating-3"></label>
            <input type="radio" name="rating"  onChange={handleRatingChange} value="2" id="rating-2" />
            <label for="rating-2"></label>
            <input type="radio" name="rating" value="1" onChange={handleRatingChange} id="rating-1" />
        ...
        <br/>
        <button onClick={saveRatingInfo} style={{marginLeft:"-90px"}} className="btn btn-dark">Submit Rating</button>
      </div>
                </div>
                <div class="col-md-6 background-muted">
                    ...
                    <div class="mt-3">
                      <table style={{display:"inline"}}>
                        <tbody>
                          <tr>
                            <td>
                      <h6 class="mb-0">Order Id: &nbsp; <span style={{color:"#0C84D9"}}>{info._id}</span></h6>{" "}
                            </td>
                            </tr>
                            <tr>
                            <td>
                      <h6 class="mb-0">
                        Date Of Delivery:  &nbsp; <span style={{color:"#0C84D9"}}>{info.dateOfDelivery}</span>
                        </h6>{" "}
                      </td>
                            </tr>
                            <tr>
                        ...
                        <h6 class="mb-0">Customer Name:  &nbsp;  <span style={{color:"#0C84D9"}}>{info.customerName}</span></h6>
                            </td> 
                            </tr>
                            <tr>
                            <td>
                        <h6 class="mb-0">Customer Email:  &nbsp;  <span style={{color:"#0C84D9"}}>{info.customerEmail}</span></h6>
                            </td>
                            </tr>
                            <tr>
                            <td>
                        <h6 class="mb-0">Customer Phone: &nbsp;   <span style={{color:"#0C84D9"}}>{info.customerPhone}</span></h6>
                            </td>
                            </tr>
                            <tr>
                            <td>
                        <h6 class="mb-0">Customer Address: &nbsp; <span style={{color:"#0C84D9"}}>{info.customerAddress}</span></h6>
                            </td>
                            </tr>
                            <tr>
                            <td>
                        <h6 class="mb-0">Customer Pincode: &nbsp;<span style={{color:"#0C84D9"}}>{info.customerPinCode}</span></h6>
                            </td>
                            </tr>
                        </tbody>
                        </table>
                  ...
                  <div class="row g-0 border-bottom">
                    <div class="col-md-6 border-right">
                      <div class="p-3 d-flex justify-content-center align-items-center">
                        {" "}
                        <span>Total Ordered Products</span>{" "}
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="p-3 d-flex justify-content-center align-items-center">
                        {" "}
                        <span>{info.totalOrderedProducts}</span>{" "}
                      </div>
                    </div>
                  </div>
                  <div class="row g-0 border-bottom">
                  ...
                  <div class="row g-0 border-bottom">
                    ...
                    <div class="col-md-6">
                      <div class="p-3 d-flex justify-content-center align-items-center">
                        {" "}
                        <span>{info.taxPrice} + 20 (Shipping Price)</span>{" "}
                      </div>
                    </div>
                  </div>
                  <div class="row g-0">
                    <div class="col-md-6">
                      <div class="p-3 d-flex justify-content-center align-items-center">
                        {" "}
                        <span class="font-weight-bold"><b>Total Price</b></span>{" "}
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="p-3 d-flex justify-content-center align-items-center">
                        {" "}
                        <span class="font-weight-bold"><b>{info.totalPrice}</b></span>{" "}
                      </div>
                    </div>
                  </div>
                </div>
